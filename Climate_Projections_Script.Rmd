...
file <- paste0("/isimip_link_list.csv")
...
for (forcing_group in names(grouped_nc_files)) {
  ...
  for (i in 1:nrow(coord_df)) {
    ...
    for (file in files_to_process) {
      ...
      # Extract data
      extracted_values <- ncvar_get(nc_file, variable_name, start = c(closest_lon_index, closest_lat_index, 1), count = c(1, 1, -1))
